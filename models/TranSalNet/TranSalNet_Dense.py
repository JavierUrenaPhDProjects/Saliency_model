...
import models.TranSalNet.utils.densenet as densenet
...
class _Decoder(nn.Module):
    ...
    def __init__(self):
        ...
        # self.TransEncoder1 = TransEncoder(in_channels=2208, spatial_size=12 * 12, cfg=cfg1)
        # self.TransEncoder2 = TransEncoder(in_channels=2112, spatial_size=24 * 24, cfg=cfg2)
        # self.TransEncoder3 = TransEncoder(in_channels=768, spatial_size=48 * 48, cfg=cfg3)
