...
import models.TranSalNet.utils.resnet as resnet
from models.TranSalNet.utils.TransformerEncoder import Encoder
...
class _Decoder(nn.Module):
    ...
    def __init__(self):
        ...
        #
        # self.TransEncoder1 = TransEncoder(in_channels=2048, spatial_size=12 * 12, cfg=cfg1)
        # self.TransEncoder2 = TransEncoder(in_channels=1024, spatial_size=24 * 24, cfg=cfg2)
        # self.TransEncoder3 = TransEncoder(in_channels=512, spatial_size=48 * 48, cfg=cfg3)
...
def TranSalNet_Res(args):
    model = TranSalNet()
    checkpoint = torch.load(
        r'/home/javier/Pycharm/PycharmProjects/Saliency_model/trained/TranSalNet_Res/TranSalNet_Res.pth',
...
#     model = TranSalNet()
#     # x = torch.randn(1, 3, 288, 384) # torch.Size([1, 2048, 9, 12])
